...
const int port = 3306;/**< port du serveur mysql */
    ...
    , ui(new Ui::MainWindow)
{
     ...
     C_bddSecu conn = C_bddSecu(databaseSecu,userSecu,passSecu);
     /*QString r = conn.rnt_username();
     cout<<"identifient est: "<<r.toLocal8Bit().constData()<<endl;*/
